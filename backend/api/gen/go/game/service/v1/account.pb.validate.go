...
func (m *GetAccountRequest) validate(all bool) error {
	...
	case *GetAccountRequest_Id:
		...
		// no validation rules for Id
	case *GetAccountRequest_UserAccount:
		if v == nil {
			err := GetAccountRequestValidationError{
				field:  "QueryBy",
				reason: "oneof value cannot be a typed-nil",
...
// Validate checks the field values on RenewMembershipRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RenewMembershipRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RenewMembershipRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RenewMembershipRequestMultiError, or nil if none found.
func (m *RenewMembershipRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *RenewMembershipRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RenewMembershipRequestMultiError(errors)
	}

	return nil
}

// RenewMembershipRequestMultiError is an error wrapping multiple validation
// errors returned by RenewMembershipRequest.ValidateAll() if the designated
// constraints aren't met.
type RenewMembershipRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RenewMembershipRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RenewMembershipRequestMultiError) AllErrors() []error { return m }

// RenewMembershipRequestValidationError is the validation error returned by
// RenewMembershipRequest.Validate if the designated constraints aren't met.
type RenewMembershipRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RenewMembershipRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RenewMembershipRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RenewMembershipRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RenewMembershipRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RenewMembershipRequestValidationError) ErrorName() string {
	return "RenewMembershipRequestValidationError"
}

// Error satisfies the builtin error interface
func (e RenewMembershipRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRenewMembershipRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RenewMembershipRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RenewMembershipRequestValidationError{}

// Validate checks the field values on CountAccountResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CountAccountResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CountAccountResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CountAccountResponseMultiError, or nil if none found.
func (m *CountAccountResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CountAccountResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CountAccountResponseMultiError(errors)
	}

	return nil
}

// CountAccountResponseMultiError is an error wrapping multiple validation
// errors returned by CountAccountResponse.ValidateAll() if the designated
// constraints aren't met.
type CountAccountResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CountAccountResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CountAccountResponseMultiError) AllErrors() []error { return m }

// CountAccountResponseValidationError is the validation error returned by
// CountAccountResponse.Validate if the designated constraints aren't met.
type CountAccountResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CountAccountResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CountAccountResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CountAccountResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CountAccountResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CountAccountResponseValidationError) ErrorName() string {
	return "CountAccountResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CountAccountResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCountAccountResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CountAccountResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CountAccountResponseValidationError{}
