...
require (
	...
	github.com/tx7do/kratos-bootstrap/config/nacos v0.2.3
	...
	github.com/tx7do/kratos-bootstrap/registry/nacos v0.2.2
...
require (
	...
	cloud.google.com/go/translate v1.16.0 // indirect
