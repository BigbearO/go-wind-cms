...
func (_q *GameAccountQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *GameAccountQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *GameAccountQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *GameAccountQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *GameAccountQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *GameAccountQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(gameaccount.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.GameAccount.Query().
//		Select(gameaccount.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *GameAccountQuery) prepareQuery(ctx context.Context) error {
	...
	if gameaccount.Policy == nil {
		return errors.New("ent: uninitialized gameaccount.Policy (forgotten import ent/runtime?)")
	}
	if err := gameaccount.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *GameAccountQuery) ForUpdate(opts ...sql.LockOption) *GameAccountQuery {
...
func (_q *GameAccountQuery) ForShare(opts ...sql.LockOption) *GameAccountQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *GameAccountQuery) Modify(modifiers ...func(s *sql.Selector)) *GameAccountSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *GameAccountSelect) Modify(modifiers ...func(s *sql.Selector)) *GameAccountSelect {
